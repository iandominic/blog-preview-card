...
const App = () => {
  return (
    <div className="w-full h-screen bg-main flex justify-center items-center">
      <div className="bg-white z-10 relative shad w-[320px] h-[490px] md:h-[510px] md:w-[340px] rounded-2xl flex flex-col  overflow-hidden p-[22px] border-black border-[1px]">
